...
describe('[IBK - Motor Insurance] Refer Risk ',async () => {
    ...
    it('[TC04a] Verify x button on more details required page from policy holder details screen',async () => {
        ...
        //Wait
        await browser.pause(1000);
        await PolicyHolderMoreDetailsRequiredPage.x_button.click()
