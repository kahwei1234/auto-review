...
import AccountNumberFlow from '../AccountNumberFlow.js';
...
class InstantTansferDetailsFlow {
         ...
         if (proxy == 'bankAccountNumber') {
            ...
            (accountNumber == 'rhbAccount'){
                ...
                (accountNumber == 'nonRHBAccount'){
                    ...
                    const {accountnumber,amountinmyr,recipientreference,paymentdetails} = NONRHB_DETAILS_3
...
export default new InstantTansferDetailsFlow