...
import SavingsPage from '../../page-objects/Savings/SavingsPage.js';
const allureReporter = require('@wdio/allure-reporter').default

describe('[IBK] Challenge Savings Nickname',async () => {
    
    it('Change Savings Nickname',async () => {
        ...
        allureReporter.addStep("Click savings button");
        //Wait
        await browser.pause(1000);
        await AccountsPage.savings_button.click()
        ...
        //Wait
        await browser.pause(1000);
        await SavingsPage.account_nickname_edit_button.click()

        allureReporter.addStep("Click account nickname field");
        //Wait
        await browser.pause(1000);
        await SavingsPage.account_nickname_field.click()
        ...
        await SavingsPage.account_nickname_field.setValue(newName);

        allureReporter.addStep("Click save button");
        //Wait
        await browser.pause(1000);
        await SavingsPage.account_nickname_save_button.click()

        allureReporter.addStep("Verify new nickname");
        //Wait
        await browser.pause(1000);
        const expected_newnickname = await SavingsPage.account_nickname.getText();
        await expect(SavingsPage.account_nickname).toHaveText(expected_newnickname);
