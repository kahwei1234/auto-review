...
describe('[IBK - Motor Insurance] Get Instant Quotation | Form',async () => {
    ...
    it('[TC05] Individual and Business tab - Verify click x button will direct to main page',async () => {
        ...
        allureReporter.addStep("Click individual tab");
        //Wait
        await browser.pause(1000);
        await GetInstantQuotationPage.individual_tab.click()
