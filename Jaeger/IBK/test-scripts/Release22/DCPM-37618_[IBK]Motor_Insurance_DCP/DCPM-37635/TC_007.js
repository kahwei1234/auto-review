import {VALID_CREDS_20} from '../../../../test-data/userAccount.js';
...
describe('[IBK - Motor Insurance] Get Instant Quotation (Individual) | Form',async () => {
    ...
    it('[TC07] Verify next button',async () => {
        ...
        //Wait
        await browser.pause(1000);
        await expect(IndividualPage.next_button).toHaveAttr('disabled')
        ...
        //Wait
        await browser.pause(1000);
        await expect(IndividualPage.next_button).toHaveAttr('tabindex', '0')
