const SEGMENT_VALUE = '//*[@id="app"]/div/section/div[2]/div[1]/section/div/div/section/section/section[3]/div[1]/section[2]'
const USERNAME_VALUE = '//*[@id="app"]/div[2]/section/div[2]/div[1]/section/div/div/section/section/section[3]/div[2]/section[2]'
const ID_TYPE_VALUE = '//*[@id="app"]/div/section/div[2]/div[1]/section/div/div/section/section/section[3]/div[3]/div[1]/section[2]'
const USER_TYPE_VALUE = '//*[@id="app"]/div/section/div[2]/div[1]/section/div/div/section/section/section[3]/div[3]/div[2]/section[2]'
...
const SLIGHT_ISSUE_OK_BUTTON = '/html/body/div[2]/div[2]/div[2]/button'
...
class DuitNowPage{
    ...
    wait_until_screen_displayed(){
        $(SLIGHT_ISSUE_OK_BUTTON).waitForDisplayed()
    }
    ...
    get slight_issue_ok_button(){
        return $(SLIGHT_ISSUE_OK_BUTTON)
    }
}
