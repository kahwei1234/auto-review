...
import CurrentPage from '../../page-objects/Current/CurrentPage.js';
const allureReporter = require('@wdio/allure-reporter').default

describe('[IBK] Challenge Current Nickname',async () => {
    
    it('Change Current Nickname',async () => {
        ...
        allureReporter.addStep("Click current button");
        //Wait
        await browser.pause(1000);
        await AccountsPage.current_button.click()
        ...
        //Wait
        await browser.pause(1000);
        await CurrentPage.account_nickname_edit_button.click()

        allureReporter.addStep("Click account nickname field");
        //Wait
        await browser.pause(1000);
        await CurrentPage.account_nickname_field.click()
        ...
        await CurrentPage.account_nickname_field.setValue(newName);

        allureReporter.addStep("Click save button");
        //Wait
        await browser.pause(1000);
        await CurrentPage.account_nickname_save_button.click()

        allureReporter.addStep("Verify new nickname");
        //Wait
        await browser.pause(1000);
        const expected_newnickname = await CurrentPage.account_nickname.getText();
        await expect(CurrentPage.account_nickname).toHaveText(expected_newnickname);
