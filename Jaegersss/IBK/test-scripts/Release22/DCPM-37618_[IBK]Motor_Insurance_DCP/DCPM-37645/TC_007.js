...
import CancelPage from '../../../../page-objects/MoreFeatures/MotorInsurance/Pay By Page/CancelPage.js'
const allureReporter = require('@wdio/allure-reporter').default

describe('[IBK - Motor Insurance] Refer Risk ',async () => {
    
    it('[TC07] Pay By Page - Verify yes button for cancel confirmation message popup',async () => {
        ...
        //Wait
        await browser.pause(4000);
        await PayByPage.x_button.click()
        ...
        //Wait
        await browser.pause(1000);
        await CancelPage.yes_button.click()
