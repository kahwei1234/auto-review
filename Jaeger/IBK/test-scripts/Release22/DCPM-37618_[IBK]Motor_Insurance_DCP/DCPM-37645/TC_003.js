...
describe('[IBK - Motor Insurance] Refer Risk ',async () => {
    ...
    it('[TC03] Quotation Details Page - Verify yes button for cancel confirmation message popup',async () => {
        ...
        allureReporter.addStep("Scroll to top");
        //Wait
        await browser.pause(1000);
        await QuotationDetailsPage.quotation_details_title.scrollIntoView()
