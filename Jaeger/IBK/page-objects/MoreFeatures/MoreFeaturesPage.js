...
const NO_ACCOUNT_MESSAGE_TITLE = '/html/body/div/div/div[4]/div/div[1]/div/div/div/div[2]/div[2]/div[1]/div/div/div[1]/div[3]/p'
const NO_ACCOUNT_COPYWRITING_1 = '(//p[contains(.,"To continue, apply for an RHB Savings/Current Account. ")])[2]'
const NO_ACCOUNT_COPYWRITING_2 = '//*[@id="mdc-dialog"]/div[1]/div/div/div[1]/div[4]/p/div/p[2]'
const RHB_INSURANCE_WEBSITE_LINK = '(//p[contains(.,"GO TO RHB INSURANCE WEBSITE")])[2]'
const NO_ACCOUNT_X_BUTTON = '(//p[contains(.,"To continue, apply for an RHB Savings/Current Account. ")]/parent::div/parent::div//child::div)[1]'
...
class MoreFeaturesPage{
    ...
    get no_account_message_title(){
        return $(NO_ACCOUNT_MESSAGE_TITLE)
    }

    get no_account_copywriting_1(){
        return $(NO_ACCOUNT_COPYWRITING_1)
    }

    get no_account_copywriting_2(){
        return $(NO_ACCOUNT_COPYWRITING_2)
    }

    get rhb_insurance_website_link(){
        return $(RHB_INSURANCE_WEBSITE_LINK)
    }

    get no_account_x_button(){
        return $(NO_ACCOUNT_X_BUTTON)
    }
