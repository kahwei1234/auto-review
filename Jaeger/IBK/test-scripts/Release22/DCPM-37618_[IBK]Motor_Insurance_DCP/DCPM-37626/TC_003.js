...
describe('[IBK - Motor Insurance] Get Instant Quotation | Form',async () => {
    ...
    it('[TC03] More button - Verify fields',async () => {
        ...
        allureReporter.addStep("Verify Individual tab");
        //Wait
        await browser.pause(1000);
        const expected_individualtab = "Individual"
        await expect(GetInstantQuotationPage.individual_tab).toHaveText(expected_individualtab)

        allureReporter.addStep("Verify Business tab");
        //Wait
        await browser.pause(1000);
        const expected_businesstab = "Business"
        await expect(GetInstantQuotationPage.business_tab).toHaveText(expected_businesstab)
